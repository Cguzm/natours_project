      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: '/api/v1/users/logout' // url: 'http://127.0.0.1:3000/api/v1/users/logout'
